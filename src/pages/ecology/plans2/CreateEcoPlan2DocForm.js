			...
			<form action="./pasropts_doc_list.html" className="create-doc__form">
				...
				<div className="create-doc__row">
					<div className="form__field">
						...
						<input type="text" name="executiveOrganization" onInput={handleInput} id="organization" className="form__field-content " />
					</div>
					<div className="form__field">
...
export default CreateEcoPlan2DocForm;