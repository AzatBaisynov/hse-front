			...
			<form action="./pasropts_doc_list.html" className="create-doc__form">
				...
				<div className="create-doc__row">
					<div className="form__field">
						...
						<input type="text" name="executiveOrganization" value={document?.organization} id="organization" className="form__field-content " />
					</div>
					<div className="form__field">
				...
				<div className="create-doc__buttons">
					<button type="submit" onClick={(e) => {
						e.preventDefault()
						navigate(`/ecology/plan2/edit/${document?.id}`, { replace: true })
...
export default ReadEcoPlan2DocForm;