			...
			<form action="./pasropts_doc_list.html" className="create-doc__form">
				...
				<div className="create-doc__row">
					<div className="form__field">
						...
						<input type="text" name="executiveOrganization" value={document?.organization} id="organization" className="form__field-content form__field-content_long" />
					</div>
				</div>
				<div className="create-doc__row">
					<div className="form__field">
						<div className="form__field-title">Номер документа разрешения</div>
						<input type="text" name="fileName" value={document?.docNumber} id="docNumber" className="form__field-content" />
					</div>
					<div className="form__field">
						<div className="form__field-title">Орган выдачи</div>
						<input type="text" name="fileName" value={document?.issuingAuthority} id="issuingAuthority" className="form__field-content" />
					</div>
				</div>
				<div className="create-doc__row">
					<div className="form__field">
						<div className="form__field-title">Дата выдачи разрешения</div>
						<input type="date" name="protocolDate" value={document?.dateGiven} id="dateGiven" className="form__field-content form__field-content_protocol-date" />
					</div>
					<div className="form__field">
						<div className="form__field-title">Нормативы выбросов</div>
						<input type="text" name="fileName" value={document?.standards} id="standards" className="form__field-content" />
					</div>
				</div>
				...
				<div className="create-doc__buttons">
					<button type="submit" onClick={(e) => {
						e.preventDefault()
						navigate(`/ecology/plan3/edit/${document?.id}`, { replace: true })
...
export default ReadEcoPlan3DocForm;