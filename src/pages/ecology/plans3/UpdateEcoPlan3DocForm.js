			...
			<form action="./pasropts_doc_list.html" className="create-doc__form">
				...
				<div className="create-doc__row">
					...
					<div className="form__field">
						...
						<input type="text" name="fileName" value={document?.standards} onInput={handleInput} id="standards" className="form__field-content" />
					</div>
				</div>
...
export default UpdateEcoPlan3DocForm;