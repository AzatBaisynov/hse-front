...
const CreateEcoUtilizationDocForm = () => {
			...
			<form action="./pasropts_doc_list.html" className="create-doc__form">
				...
				<div className="create-doc__field" >
					...
					<div className="create-doc__upload-file create-doc__field-content" style={{ width: "886px" }}>
						...
						<input type="file" id="file1" hidden onInput={handleSelectFiles1} />
					</div>
				</div>
				<div className="create-doc__field" >
					<div className="create-doc__field-title">Загрузка документа</div>
					<div className="create-doc__upload-file create-doc__field-content" style={{ width: "886px" }}>
						...
						<input type="file" id="file2" hidden onInput={handleSelectFiles2} />
					</div>
				</div>
				<div className="create-doc__field" >
					<div className="create-doc__field-title">Загрузка документа</div>
					<div className="create-doc__upload-file create-doc__field-content" style={{ width: "886px" }}>
						<label htmlFor="file3" >
							<span className="create-doc__label">
								<img src={uploadIcon} alt="" />
								<span>{file3?.name || "Нажмите или перетащите файл для загрузки"}</span>
							</span>
						</label>
						<input type="file" id="file3" hidden onInput={handleSelectFiles3} />
					</div>
				</div>
...
export default CreateEcoUtilizationDocForm;