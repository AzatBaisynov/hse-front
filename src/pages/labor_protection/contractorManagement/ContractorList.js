      ...
      <table className="doc-table">
        <tbody>
          <tr className="doc-table__row doc-table__row_titles">
            <td>Наименование организации подрядчика</td>
            <td>Код документа</td>
            <td>Дата договора</td>
            <td>Предмет договора - описание услуги / товара</td>
            <td>Департамент ответственный за Договор</td>
          </tr>
          ...
          Object.keys(back).map((key, idx) => (
              <tr
                ...
                onClick={(e) => {
                  navigate(`/labor/contractors/cards/get/${back[key].id}`, { replace: true });
                }}
              >
