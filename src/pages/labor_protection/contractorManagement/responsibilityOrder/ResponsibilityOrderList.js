    ...
    <div className="doc-list-container">
      <div className="doc-list__head-panel">
        <div className="doc-list__buttons">
          <NavLink
            exact
            to="/labor_protection/folders/13/nest/0"
          ...
          <NavLink
            exact
            to="/labor/contractors/responsibility_order"
      ...
      <table className="doc-table">
        <tbody>
          <tr className="doc-table__row doc-table__row_titles">
            <td>Наименование совместного приказа</td>
            <td>Код документа</td>
            <td>Номер совместного приказа</td>
            <td>Дата совместного приказа</td>
          </tr>
          ...
          Object.keys(back).map((key, idx) => (
              <tr
                ...
                onClick={(e) => {
                  navigate(`/labor/contractors/orders/get/${back[key].id}`, { replace: true });
                }}
              >
                <td>{back[key]?.orgName}</td>
                <td>{back[key]?.id}</td>
                <td>{back[key]?.agreementDate}</td>
                <td>{back[key]?.project}</td>
                <td>{back[key]?.approvalDepp}</td>
              </tr>
            ))}
        </tbody>
      </table>
...
export default ResponsibilityOrderList;
