        ...
        <tbody>
          ...
          Object.keys(back).map((key, idx) => (
              <tr
                ...
                onClick={(e) => {
                  navigate(`/labor/employees/cards/get/${back[key].id}`, { replace: true });
                }}
              >
                <td>{back[key]?.id}</td>
                <td>{back[key]?.employeeSurname}</td>
                <td>{back[key]?.employeeName}</td>
                <td>{back[key]?.employeePatronymic}</td>
