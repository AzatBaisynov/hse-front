          ...
          <table className="ensk-table">
            <tbody>
              ...
              <tr className="table-input">
                ...
                <td>
                  <select id="employeeSex" onInput={handleInput}>
                ...
                <td>
                  <input type="date" id="lastCheckDate" onInput={handleInput} />
                </td>
                <td>
                  <input type="text" id="profDanger" onInput={handleInput} />
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="ensk" style={{ marginTop: "25px" }}>
          <table className="ensk-table">
            <tbody>
              ...
              <tr className="table-input">
                <td>
                  <input type="text" id="checkPeriod" onInput={handleInput} />
                </td>
                <td>
                  <select id="periodType" onInput={handleInput}>
                ...
                <td>
                  <select id="workValidity" onInput={handleInput}>
