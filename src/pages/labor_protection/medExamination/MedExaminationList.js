    ...
    <div className="doc-list-container">
      <div className="doc-list__head-panel">
        <div className="doc-list__buttons">
          <NavLink
            exact
            to="/labor_protection/folders/12/nest/0"
          ...
          <NavLink
            exact
            to="/labor/employees/med_examination"
      ...
      <table className="doc-table">
        <tbody>
          <tr className="doc-table__row doc-table__row_titles">
            <td>Код документа</td>
            <td>ФИО / Name</td>
            <td>Структурное подразделение/ Organizational division</td>
            <td>Должность / Position</td>
            <td>Периодичность осмотра / Period of check</td>
          </tr>
          ...
          {Object.keys(back).map((key, idx) => (
            <tr
              ...
              onClick={(e) => {
                navigate(`/labor/employees/med_examination/get/${back[key].id}`, {
                  replace: true,
                });
              }}
            >
...
export default MedExaminationList;
