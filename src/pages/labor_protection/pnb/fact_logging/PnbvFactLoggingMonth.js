...
const PnbvFactLoggingMonth = () => {
  ...
  const handleSend = async (e) => {
    ...
    try {
      if (file?.name) {
        ...
        try {
          await axios.post(
            `${_LINK}/v1/api/file/excel?skip=8&type=14&date=2022-10-12`,
            formData,
            {
              headers: {},
            }
  ...
  useEffect(() => {
    const getArray = async () => {
      const config = {
        method: "get",
        url: `${_LINK}/v1/api/file/excel/get?type=14`,
        headers: {
      ...
      <div className="doc-list__content">
        ...
        <div className="doc-list__head-panel">
          ...
          <p className="head-panel__title">
            Незапланированные записи по факту ПНБР на {month} {year} г.
          </p>
          {/* SEARCH AND FILTER */}
...
export default PnbvFactLoggingMonth;
