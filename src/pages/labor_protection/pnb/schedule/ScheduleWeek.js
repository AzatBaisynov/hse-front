...
const ScheduleWeek = () => {
  ...
  const handleSend = async (e) => {
    ...
    try {
      if (file?.name) {
        ...
        try {
          await axios.post(
            `${_LINK}/v1/api/file/excel?skip=8&cols=0&type=6&date=2022-10-12`,
            formData,
            {
              headers: {},
            }
  ...
  useEffect(() => {
    const getArray = async () => {
      const config = {
        method: "get",
        url: `${_LINK}/v1/api/file/excel/get?type=6`,
        headers: {
        ...
        <div className="doc-list__head-panel">
          ...
          <div className="doc-list__buttons">
            ...
            <div className="form__field head-panel__week">
              <div className="form__field-title form__field-title_blue" style={{width: "70px"}}>
                Неделя:
              </div>
              <input
                type="week"
