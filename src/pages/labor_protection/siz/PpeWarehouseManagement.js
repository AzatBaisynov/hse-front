...
const PpeWarehouseManagement = () => {
  ...
  useEffect(() => {
    const getArray = async () => {
      const config = {
        method: "get",
        url: `${_LINK}/v1/api/file/excel/get?type=3`,
        headers: {
      ...
      <div className="ensk">
        <table className="ensk-table">
          <thead>
            <tr>
              <th>Код /Code</th>
              <th>НН_детальный / Detailed No.</th>
              <th>Наименование_детальный / Name of PPE detailed</th>
              <th>Завод / Warehouse</th>
              <th>СкладЗапаса / Warehouse stock</th>
              <th>Ед_изм / Unit of measure</th>
              <th>ОстаткиКолич / Remaining quantity</th>
              <th>Цена / Price</th>
              <th>ОстаткиСумм / Amount of remaining PPE</th>
            </tr>
          </thead>
            {createTable()}
        </table>
