        ...
        <table className="ensk-table">
          <thead>
            <tr>
              ...
              <th colSpan={12} style={{'text-align': 'center'}}>Расход топлива, л / Fuel consumption, l</th>
              <th rowSpan={2}>Расход топлива за год, л / Fuel consumption per year, l</th>
              <th rowSpan={2}>Комментарий / Comments</th>
            </tr>
            <tr>
