...
const PpeWarehouseManagement = () => {
  ...
  const handleSend = async (e) => {
    ...
    try {
      if (file?.name) {
        ...
        try {
          await axios.post(
            `${_LINK}/v1/api/file/excel?skip=2&type=18&date=2022-12-19`,
            formData,
            {
              headers: {},
            }
  ...
  useEffect(() => {
    const getArray = async () => {
      const config = {
        method: "get",
        url: `${_LINK}/v1/api/file/excel/get?type=18`,
        headers: {
      ...
      <div className="doc-list__content">
        ...
        <div className="doc-list__head-panel">
          ...
          <div className="doc-list__buttons">
            <a
              href="/labor_protection/folders/12/nest/0"
      ...
      <div className="ensk">
        <table className="ensk-table">
          <thead>
            <tr>
              <th>№</th>
              <th>Структурные подразделения и должности</th>
              <th>Хим.вещества в ВРЗ</th>
              <th>АПФД в ВРЗ</th>
              <th>Биол. фактор</th>
              <th>Шум</th>
              <th>Ультразвук</th>
              <th>Инфразвук</th>
              <th>Вибрация общая</th>
              <th>Вибрация локальная </th>
              <th>Ионизирующие излучения </th>
              <th>Неонизирующие излучения </th>
              <th>Электростатическое поле </th>
              <th>Постоянное магнитное поле </th>
              <th>Эл.П. пром.частоты 50 герц</th>
              <th>ЭМП ВДТ и ПК </th>
              <th>Электромагн. излучения РЧД</th>
              <th>Лазерное излучение</th>
              <th>Ультрафиолетовое излучение</th>
              <th>Микроклимат теплый период года</th>
              <th>Микроклимат холодный период года</th>
              <th>Освещение </th>
              <th>Тяжесть труда  </th>
              <th>Напряженность труда  </th>
              <th>Общая оценка условий труда</th>
              <th></th>
              <th></th>
            </tr>
          </thead>
...
export default PpeWarehouseManagement;
